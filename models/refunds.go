...
type WechatRefundDetail struct {
	...
	RefundNo string `gorm:"type:varchar(32)" json:"out_refund_no" `
	// 微信支付交易订单号
	TransactionId *string `gorm:"type:varchar(32)" json:"transaction_id"`
	// 原支付交易对应的商户订单号
	...
	UserReceivedAccount *string `gorm:"type:varchar(32)" json:"user_received_account"`
	...
	FundsAccount *string `gorm:"type:varchar(32)" json:"funds_account,omitempty"`
	// 金额详细信息
